...
int main()
{
    ...
    game1.Create_text("9", "Вы деретесь с тролеем. По виду, у него осталось еще 5 хп. \n1.Ударить рукой \n2.Попытаться обжечь зажигалкой", new int[2] {3, 4});
    game1.Create_text("10", "@", new int[2] {6, 6}, 8);
    game1.Create_text("11", "Троль вас не понимает", new int[1] {9});
    game1.Create_text("12", "Что будем делать дальше? \n1. Искать выход \n2. Поджечь комнату", new int[2] {3, 4});
    game1.Create_text("13", "Что будем делать дальше? \n1. Искать выход \n2. Поджечь комнату", new int[2] {3, 4});
    game1.Create_text("14", "Что будем делать дальше? \n1. Искать выход \n2. Поджечь комнату", new int[2] {3, 4});
    game1.Create_text("15", "Что будем делать дальше? \n1. Искать выход \n2. Поджечь комнату", new int[2] {3, 4});
    game1.Create_text("16", "Что будем делать дальше? \n1. Искать выход \n2. Поджечь комнату", new int[2] {3, 4});
    game1.Create_text("17", "Что будем делать дальше? \n1. Искать выход \n2. Поджечь комнату", new int[2] {3, 4});
    game1.Create_text("18", "Что будем делать дальше? \n1. Искать выход \n2. Поджечь комнату", new int[2] {3, 4});
    game1.Create_text("19", "Что будем делать дальше? \n1. Искать выход \n2. Поджечь комнату", new int[2] {3, 4});
    game1.Create_text("20", "Что будем делать дальше? \n1. Искать выход \n2. Поджечь комнату", new int[2] {3, 4});
